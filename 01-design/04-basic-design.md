...
| SC-03 | ホーム（home タブ） | 日常の起点・実施準備 | レベルバー、ストリーク・倍率、キャラビュー／種目ビュー、種目カルーセル、秒数スライダー、EXP 見込み、スタート | スタート→SC-07。タブ→SC-04 / SC-09 |
| SC-04 | 記録（記録タブ） | 履歴・振り返り | 月間カレンダー、実施マーク、最長ストリーク、称号一覧 | タブ→SC-03 / SC-09 |
...
| SC-09 | 設定（設定タブ） | 設定 | デフォルト秒数、通知 ON/OFF（任意）、データリセット | タブ→SC-03 / SC-04 |
...
| 下部タブ | ナビゲーション | home（現在地）/ 記録（SC-04）/ 設定（SC-09） |
